...
async def publish_workspace_binding_change(
    workspace_id: str, status: str, computer_id: str
) -> None:
    """Wake a subscriber that opened before a legacy workspace was bound."""
    await _publish(
