...
@pytest.mark.asyncio
async def test_unreadable_stop_heartbeat_is_unknown_not_live():
    cache = _StopCache()
    cache.client.exists = None
    assert await coord.computer_stop_heartbeat_present("comp-1", cache=cache) is None
