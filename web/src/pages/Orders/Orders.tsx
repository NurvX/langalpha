      ...
      <div ref={pageRef} className="orders-scroll">
        <div className="orders-container">
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Only when there is nothing to show. The same `error` is raised
                by a later page failing, and the pages already read stay in the
                cache throughout, so reading it alone threw away a list the
                query was still holding. */}
